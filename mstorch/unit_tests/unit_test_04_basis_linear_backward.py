...
prev_output_t = torch.tensor(prev_output)
...
mlcv_linear.forward(input=prev_output)
torch_linear(prev_output_t)

raise NotImplementedError("Test not complete below this point.")
# Not really sure how to get the gradient for pytorch weights...
# TODO: Complete this test

# Calculate the gradient
mlcv_backward = mlcv_linear.backward()

torch_linear.weight.backward()
torch_backward = prev_output_t.grad.detach().numpy()
